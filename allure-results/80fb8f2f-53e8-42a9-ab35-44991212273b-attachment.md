...
```ts
  ...
  95  | 
> 96  |   expect(updatedUser.username).toBe('hamas_rafique');
      |                                ^ Error: expect(received).toBe(expected) // Object.is equality
  97  | 
  98  | 
  99  |   // ==========================================
  ...
  125 | 
  126 |   console.log(
  127 |     'GET After Delete Status:',
  128 |     GETAfterDelete.status()
  129 |   );
  130 | 
  131 |   expect(GETAfterDelete.status()).toBe(404);
  132 | 
  133 | });
  134 | 
```
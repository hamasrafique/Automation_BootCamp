...
> 101 |       expect(putResponse.status()).toBe(200);
  ...
  131 | 
  132 |       expect(updatedUser.email)
  133 |         .toBe(userData.update.email);
  134 | 
  135 |       expect(updatedUser.username)
  136 |         .toBe(userData.update.username);
  137 | 
  138 | 
  139 |       // ==========================================
  140 |       // 8. LOGIN WITH UPDATED DATA
  141 |       // ==========================================
  142 | 
  143 |       const loginAfterPut = await request.post(
  144 |         'https://api-testing-postman.vercel.app/api/v1/users/login',
  145 |         {
  146 |           data: {
  147 |             ...userData.update,
  148 |             password: userData.register.password
  149 |           }
  150 |         }
  151 |       );
  152 | 
  153 |       console.log(
  154 |         'Login After PUT:',
  155 |         loginAfterPut.status()
  156 |       );
  157 | 
  158 |       expect(loginAfterPut.status()).toBe(200);
  159 | 
  160 |       const newLoginData =
  161 |         await loginAfterPut.json();
  162 | 
  163 |       const newHeaders = {
  164 |         Authorization: `Bearer ${newLoginData.token}`
  165 |       };
  166 | 
  167 | 
  168 |       // ==========================================
  ...
  170 |       // ==========================================
  171 | 
  172 |       const deleteResponse = await request.delete(
  173 |         'DELETE_URL_FROM_SWAGGER',
  174 |         {
  ...
  179 |       console.log(
  180 |         'DELETE:',
  181 |         deleteResponse.status()
  182 |       );
  183 | 
  184 |       expect(deleteResponse.status()).toBe(200);
  185 | 
  186 | 
  187 |       // ==========================================
  188 |       // 10. GET AFTER DELETE
  189 |       // ==========================================
  190 | 
  191 |       const getAfterDelete = await request.get(
  192 |         'https://api-testing-postman.vercel.app/api/v1/users/current-user',
  193 |         {
  ...
  197 | 
  198 |       console.log(
  199 |         'GET After Delete:',
  200 |         getAfterDelete.status()
  201 |       );
```